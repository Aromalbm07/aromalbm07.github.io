...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.innerWidth > 992) { // Only apply parallax on larger screens
        heroSection.addEventListener('mousemove', (e) => {
            ...
            parallaxElements.forEach(el => {
                ...
                // Use transform string format dynamically
                // Need to carefully handle if it's the portrait image or the floating badges
                if (el.classList.contains('portrait-image')) {
                     el.style.transform = `translate(${xPos}px, ${yPos}px)`;
                } else if (el.classList.contains('badge-1')) {
                    // Combine parallax with the floating animation
    ...
    // Using a sleek, connected-dots futuristic structure
